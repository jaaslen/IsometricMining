...
## Game Data
- Since the game is not complete, the game data is all from testing. if you really want to play this unfinished tech demo, you can copy the contents of the "BaseSaveData.JSON" file into SaveData.JSON.
